...
This project can be built and run in Microsoft Visual Studio 2022, and the GLUT and GLUI libraries must be compiled and included in the includes folder on the local machine. 
